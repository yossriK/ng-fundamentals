...
export class EventService {
    ...
    // ajax call to get me stuff from the server
    getEvents() : Observable<IEvent[]> { // we returnign observable here not an array of IEvents so thats why we specified Subject<IEvent>, later we will change it to observable
